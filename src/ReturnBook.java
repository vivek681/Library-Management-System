...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void t1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t1KeyReleased
        ...
        {
            connect();
            query="select * from Issued where S_ID='"+t1.getText()+"';";
            rs=stmt.executeQuery(query); 
            int i=0;
            while(rs.next())
            {
                i++;
            t2.setText(rs.getString("S_Name"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            if(rs.next())
            {
                ...
                query="delete from Issued where S_ID='"+t1.getText()+"';";
                stmt.executeUpdate(query);
                query="update Books set Available='YES' where ID='"+t3.getText()+"';";
                stmt.executeUpdate(query);
                disconnect();
