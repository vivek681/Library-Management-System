...
public class IssueBook extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (t2.getText().equals("")) {
            ...
            try {
                connect();
                query = "select * from Books where ID='" + t3.getText() + "';";

                rs = stmt.executeQuery(query);
                rs.next();
                if (t6.getText().equals("YES")) {
                    query="insert into Issued values('"+t1.getText()+"','"+t2.getText()+"','"+t3.getText()+"','"+t4.getText()+"','"+Address+"','"+t5.getText()+"','"+SStream+"','"+SClass+"');";
                            
                            stmt.executeUpdate(query);
  
                   JOptionPane.showMessageDialog(this, "Book with ID = " + t3.getText() + " has been issued to " + t2.getText());
                   query = "update Books set Available ='NO' where ID='"+t3.getText()+"';";
                    stmt.executeUpdate(query);
    ...
    private void t1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t1KeyReleased
        try {
            connect();
            query = "select * from Registration where ID='" + t1.getText() + "';";
            rs = stmt.executeQuery(query);
            if (rs.next()) {
