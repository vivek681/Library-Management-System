...
public class IssuedBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        c1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Stream", "Mechanical", "ComputerScience", "Electrical" }));
        ...
        c2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Course", "Diploma", "B.Tech", "M.Tech" }));
    ...
    private void c1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c1ActionPerformed
        if(c1.getSelectedItem()=="Mechanical")
        {
            c2.removeAllItems();
            c2.addItem("Select Course");c2.addItem("Diploma");c2.addItem("B.Tech");c2.addItem("M.Tech");
        }
        if(c1.getSelectedItem()=="ComputerScience")
        {
            c2.removeAllItems();
            c2.addItem("Select Course");c2.addItem("Diploma");c2.addItem("B.Tech");c2.addItem("M.Tech");
        }
        if(c1.getSelectedItem()=="Electrical")
        {
            c2.removeAllItems();
            c2.addItem("Select Course");c2.addItem("Diploma");c2.addItem("B.Tech");c2.addItem("M.Tech");
        }
    ...
    private void c2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c2ActionPerformed
        ...
        {
            connect();
            query="select * from Issued where Sstream='"+c1.getSelectedItem()+"' and Sclass='"+c2.getSelectedItem()+"';";
            rs=stmt.executeQuery(query); 
            DefaultTableModel model=(DefaultTableModel)table.getModel();
            model.setRowCount(0);
            while(rs.next())
            {
            Object[] row = {rs.getString("S_ID"),rs.getString("S_Name"),rs.getString("Book_ID"),rs.getString("Book_Name"),rs.getString("Address"),rs.getString("IssueDate")};
            model.addRow(row);
            }
        }
        catch(Exception e)
    ...
    public void connect()
    {
        ...
        {  
            ...
            "jdbc:mysql://localhost:3306/it_b","root","mysql");  
