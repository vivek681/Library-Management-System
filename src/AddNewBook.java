...
public class AddNewBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        c3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Stream", "Mechanical", "ComputerScience", "Electrical", " " }));
        ...
        c4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Course", "Diploma", "B.Tech", "M.Tech" }));
    ...
    private void c3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c3ActionPerformed
        if(c3.getSelectedItem()=="Mechanical")
        {
            c4.removeAllItems();
            c4.addItem("Select Course");c4.addItem("Diploma");c4.addItem("B.Tech");c4.addItem("M.Tech");
        }
        if(c3.getSelectedItem()=="ComputerScience")
        {
            c4.removeAllItems();
            c4.addItem("Select Course");c4.addItem("Diploma");c4.addItem("B.Tech");c4.addItem("M.Tech");
        }
        if(c3.getSelectedItem()=="Electrical")
        {
            c4.removeAllItems();
            c4.addItem("Select Course");c4.addItem("Diploma");c4.addItem("B.Tech");c4.addItem("M.Tech");
        }
